...
namespace Ex04.Menus.Delegates
{
    ...
    public class Menu
    {
        ...
        public Menu CreateSubMenu(String i_SubMenuName)
        {
            ...
            MenuItem subMenuItem = CreateMenuOption(i_SubMenuName, addedSubMenu);

            subMenuItem.ItemChosen += 
                new ItemChosenHandler(submenu_ChosenItem_EvenHandler);
...
startingChoiceNumbering, m_MenuItems.Count);
        ...
        private void reciveUserInput (out int o_userIntInput) 
        {
            ...
            {
                throw new Exception
                    ("Input out of range! Please Enter an int in the correct range!");
            }
        }

        private void submenu_ChosenItem_EvenHandler(Object sender)
        {
